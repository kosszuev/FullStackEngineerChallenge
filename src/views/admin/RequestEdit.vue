<template>
  <div class="wrapper">
    ...
    <h2 class="mb-5 text-3xl uppercase text-gray-600">Edit Review Request</h2>
      ...
      <form @submit.prevent="handleForm">
        <div class="shadow overflow-hidden sm:rounded-md">
          <div class="px-4 py-5 bg-white sm:p-6">
            ...
            <div class="justify-left px-8 my-4 select-none flex flex-wrap">
  ...
  methods: {
    handleForm() {
      if (!this.reviewers.length) {
        ...
        requests.updateRequest(this.id, request).then(() => {
          alert.setMessage("Request was successfully edited!");
  ...
  mounted() {
    ...
    requests
      ...
      .then((res) => {
        ...
        this.reviewersIds = res.reviewersIds;
      })
      .then(() => {
        this.employees.forEach((employee) => {
          if (this.reviewersIds.includes(employee.id)) {
            assignedReviewers.push(employee);
          }
        });
        this.reviewers = assignedReviewers;
      });
  },
};
</script>
